    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
          <div class="col-md-4">
            ...
            <select class="form-control" name="" id="concepto">
              ...
              <?php
              $depas = mysqli_query($con, "SELECT * FROM Fallas WHERE id_cliente = '$id_cliente' ORDER BY NombreNombre ASC");
        ...
        <script type="text/javascript">
          function busca(){
            ...
            var url = "reportesolicitud.php?concepto=" + concepto + "&tipo=" + tipo; // El script a dónde se realizará la petición.
            $.ajax({
               url: url,
               beforeSend: function () {
                 $(".tablamain").html("");

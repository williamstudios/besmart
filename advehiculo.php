...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
          <div class="col-lg-6">
            <form action="vehicsave.php" method="post">
            <div class="card">
              <div class="card-header"><strong>Nuevo Almacen</strong><small></small></div>
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">Kilometraje</label>

...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
          <div class="col-lg-6">
            <form action="artsave.php" method="post">
            <div class="card">
              <div class="card-header"><strong>Nuevo artículo</strong><small></small></div>
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">Costo</label>
                  <input class="form-control" type="text" name="costo"  placeholder="Costo" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Mínimo</label>
                  <input class="form-control" type="text" name="minimo"  placeholder="Stock" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Máximo </label>
                  <input class="form-control" type="text" name="mximo"  placeholder="Stock" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Stock</label>
                  <input class="form-control" type="text" name="stock" id="apemat" placeholder="Stock" required>
                </div>
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">Almacén</label>
                  <div class="row">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nom" id="nalma" placeholder="Nombre" required>
                      </div>
                      <div class="form-group moddepa" >
                        <label for="company" class=" form-control-label">Departamento</label>
                        <select class="form-control select2" name="depar">
                          <option value="">Seleccionar</option>
                          <?php
                          $depas = mysqli_query($con, "SELECT * FROM Departamentos WHERE id_cliente = '$id_cliente' ORDER BY Nombre ASC");
                          while ($rdepas = mysqli_fetch_assoc($depas)) {
            ...
            <script type="text/javascript">
              function falma(){
                ...
                if (nomb == "") {
                  ...
                  var url = "procesas/almasave.php"; // El script a dónde se realizará la petición.
                  $.ajax({
                     type: "POST",
                     url: url,

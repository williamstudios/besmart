            ...
            <div class="card">
              ...
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="apep" id="apepat" placeholder="Apellido Paterno" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Apellido Materno</label>
                  <input class="form-control" type="text" name="apem" id="apemat" placeholder="Apellido Materno" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="usuario" id="mail" placeholder="Usuario" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Contraseña</label>
                  <input class="form-control" type="text" name="contra" id="mail" placeholder="Contraseña" required>
                </div>
                <div class="form-group">

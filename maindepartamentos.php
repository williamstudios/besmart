            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <button type="button" name="button" class="btn btn-warning" onclick="window.location='admaindepa.php'">Agregar</button>
                          <table id="tabla" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                              $busca = mysqli_query($con, "SELECT * FROM main_Departamentos WHERE id_cliente = '$id_cliente'");
                              while ($result = mysqli_fetch_assoc($busca)) {
                                echo '<tr>
                                  <td><a href="#">' . $result["Nombre"] .'</a></td>
                                  <td>$' . $result["presupuesto"] .'</td>

                                ...
                                <tbody>
                                  ...
                                  while ($result = mysqli_fetch_assoc($busca)) {
                                    ...
                                    echo '<tr>
                                     ...
                                     <td>' . $result["hora_crea"] .'</td>
                                     <td>' . $stat .'</td>
                                     <td> <button type="button" name="button" class="btn btn-info" data-toggle="modal" data-target="#largeModal2" onclick="buscando2('. $result["id"] .')"><i class="fa fa-check-circle" aria-hidden="true"></i></button> </td>
                                     <td> <button type="button" name="button" class="btn btn-danger" onclick="eliminarlo('. $result["id"] .')"><i class="fa fa-trash" aria-hidden="true"></i></button> </td>
                                    </tr>';
                                  }
                                  ?>

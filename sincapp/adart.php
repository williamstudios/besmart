            ...
            <div class="card">
              ...
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="costo" id="apepat" placeholder="Costo" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="almacen" onchange="almac(this.value)">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="almacen">
                    ...
                    while ($rdepas = mysqli_fetch_assoc($depas)) {
                      echo '<option value="' . $rdepas["id"] .'" class="almacenes alma'. Departamento .'" style="display:none;">' . $rdepas["Nombre"] .'</option>';
                    }
                    ?>
                  </select>
                  <script type="text/javascript">
                    function almac(valor){
                      $(".almacenes").hide();
                      $(".alma" + valor).hide();
                    }
                  </script>

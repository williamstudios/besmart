            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <table id="tabla" class="table table-striped table-bordered"> <button type="button" name="button" class="btn btn-warning" onclick="window.location='addalma.php'">Agregar</button>
                            <thead>
                              <tr>
                                <th>Almacen</th>
                                <th>Departamento</th>
                            ...
                            <tbody>
                              <?php
                              $busca = mysqli_query($con, "SELECT alma.*, depas.Nombre AS depa FROM Almacenes AS alma INNER JOIN Departamentos AS depas ON alma.Departamento = depas.id WHERE alma.id_cliente = '$id_cliente'");

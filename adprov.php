...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
          <div class="col-lg-6">
            <form action="provsave.php" method="post">
            <div class="card">
              <div class="card-header"><strong>Nuevo proveedor</strong><small></small></div>
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">RFC</label>
                  <input class="form-control" type="text" name="rfc" id="apepat" placeholder="RFC" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Ciudad</label>
                  <input class="form-control" type="text" name="ciudad" id="apemat" placeholder="Ciudad" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Estado</label>
                  <input class="form-control" type="text" name="estado" id="mail" placeholder="Estado" step="any" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Domicilio</label>
                  <textarea name="domicilio" rows="2" class="form-control" required></textarea>
                </div>
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">Contacto</label>

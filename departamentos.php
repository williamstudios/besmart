            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <button type="button" name="button" class="btn btn-warning" onclick="window.location='addepa.php'">Agregar</button>
                          <table id="tabla" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                              $busca = mysqli_query($con, "SELECT sub.*, deps.Nombre AS depa FROM Departamentos AS sub INNER JOIN main_Departamentos deps ON sub.main_dep = deps.id WHERE sub.id_cliente = '$id_cliente'");

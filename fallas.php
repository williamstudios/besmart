                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tipos de solicitudes</strong>
                        </div>
                        <div class="card-body">
                          <table id="tabla" class="table table-striped table-bordered"> <button type="button" name="button" class="btn btn-warning" onclick="window.location='adfalla.php'">Agregar</button>
                            <thead>
                              <tr>
                                <th>Descripcion</th>
                              </tr>
                            ...
                            <tbody>
                              <?php
                              $busca = mysqli_query($con, "SELECT NombreNombre FROM Fallas WHERE id_cliente = '$id_cliente'");
                              while ($result = mysqli_fetch_assoc($busca)) {
                                echo '<tr>
                                  <td><a href="#">' . $result["NombreNombre"] .'</a></td>
                                </tr>';
                              }
                              ?>

...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="card-body">
                          <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                              <a class="nav-item nav-link active show" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Asignadas</a>
                                  ...
                                  while ($result = mysqli_fetch_assoc($busca)) {
                                    ...
                                    echo '<tr>
                                     ...
                                     <td> <button type="button" name="button" class="btn btn-rimary" data-toggle="modal" data-target="#fotosmodal" onclick="buscandof('. $result["id"] .')"><i class="fa fa-camera" aria-hidden="true"></i></button> </td>';
                                      if ($result["status"] == 4) {
                                        echo '<td> <button type="button" name="button" class="btn btn-info" data-toggle="modal" data-target="#largeModal" onclick="buscando('. $result["id"] .')"><i class="fa fa-eye" aria-hidden="true"></i></button> </td>';
                                      } else {
                                        echo '<td> <button type="button" name="button" class="btn btn-info" data-toggle="modal" data-target="#largeModal2" onclick="buscando2('. $result["id"] .')"><i class="fa fa-eye" aria-hidden="true"></i></button> </td>';
                                      }
                                    echo '</tr>';
                                  }
                                  ?>
        ...
        <div class="modal fade" id="largeModal" role="dialog" aria-labelledby="largeModalLabel" style="display: none;" aria-hidden="true">
          <form class="" action="asignar4.php" method="post">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <div class="modal fade" id="largeModal2" role="dialog" aria-labelledby="largeModalLabel" style="display: none;" aria-hidden="true">
          <form class="" action="asignar3.php" method="post">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Información de petición</h5>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-primary" id="reasignar">Trabajar</button>
                <button type="button" name="button" class="btn btn-rimary" onclick="printer()">Imprimir</button>
              </div>
              </div>
          </div>

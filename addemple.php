...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
          <div class="col-lg-6">
            <form action="emplesave.php" method="post">
            <div class="card">
              ...
              <div class="card-body card-block">
                ...
                <div class="form-group">
                  <label for="company" class=" form-control-label">Salario</label>
                  <input class="form-control" type="number" name="salario" id="mail" placeholder="Salario" step="any" required>
                </div>
                <div class="form-group">
                  <label for="company" class=" form-control-label">Domicilio</label>
                  <textarea name="domicilio" rows="2" class="form-control"></textarea>
                </div>
                <div class="form-group">
